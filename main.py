...
#Dá loop na música
@client.command(brief='Dá loop na música.', description='Repete a música atual.')
async def loop(ctx):
    voice = get(client.voice_clients, guild=ctx.guild)
    voice.loop()
...
#Envia um url randomizado de para o play
@client.command(brief='Música aleatória de Ambiente Infernal.', description='Pega uma música aleatória de Ambiente Infernal e a toca.')
...
#Envia um url randomizado de para o play
@client.command(brief='Música aleatória de Ambiente Calmo.', description='Pega uma música aleatória de Ambiente Calmo e a toca.')
...
#Envia um url randomizado de para o play
@client.command(brief='Música aleatória do Kasinão.', description='Pega uma música aleatória do Kasinão e a toca.')
